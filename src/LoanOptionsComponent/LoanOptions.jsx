...
const LoanOptions = () => {
  ...
  <Container className="mt-0">
      {/* top heading bar */}
      <div className="after-nav-container mb-5 ">
      <h1 className="site-title text-center text-dark mt-5">
        When banks compete, <span className="site-title">you win.</span>
      </h1>
      </div>
    {/* ending of top heading bar */}

    <Tab.Container defaultActiveKey="personalLoans" >
      <Row>
        <Col>
          <Nav variant="pills" className="justify-content-center loan-nav">
            <Nav.Item>
      ...
      <Tab.Pane eventKey="personalLoans">
        <div className="options-box">
          <section className="options-content-section">
            ...
            className="btn btn-secondary btn-md options-compare-button"
